...
import UtiliCards from './UtiliCards';
const Utilities = () => {
    const Doc = [
        {
            id: 1,
            head: 'Document',
            lines: 'Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae viverra amet et. Erat nam molestie. Vitae mollis lacus senectus mattis nisl. Porta , adipiscing sed mus diam amet, ac sed tellus. ',
            Image: <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none">
                <path d="M32.6654 4.6665L13.9987 4.6665C12.761 4.6665 11.574 5.15817 10.6989 6.03334C9.8237 6.90851 9.33203 8.09549 9.33203 9.33317L9.33203 46.6665C9.33203 47.9042 9.8237 49.0912 10.6989 49.9663C11.574 50.8415 12.761 51.3332 13.9987 51.3332L41.9987 51.3332C43.2364 51.3332 44.4234 50.8415 45.2985 49.9663C46.1737 49.0912 46.6654 47.9042 46.6654 46.6665L46.6654 18.6665L32.6654 4.6665Z" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className='group-hover:stroke-black duration-500' />
                <path d="M32.668 4.6665V18.6665H46.668" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className='group-hover:stroke-black duration-500' />
                <path d="M37.3346 30.3335L18.668 30.3335" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className='group-hover:stroke-black duration-500' />
                <path d="M37.3346 39.6665H18.668" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className='group-hover:stroke-black duration-500' />
                <path d="M23.3346 21H21.0013H18.668" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className='group-hover:stroke-black duration-500' />
            </svg>,
        },
        {
            id: 2,
            ...
            lines: 'Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae viverra amet et. Erat nam molestie. Vitae mollis lacus senectus mattis nisl. Porta , adipiscing sed mus diam amet, ac sed tellus.  ',
            Image: <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none">
                <path d="M46.668 16.3335H9.33464C6.75731 16.3335 4.66797 18.4228 4.66797 21.0002V44.3335C4.66797 46.9108 6.75731 49.0002 9.33464 49.0002H46.668C49.2453 49.0002 51.3346 46.9108 51.3346 44.3335V21.0002C51.3346 18.4228 49.2453 16.3335 46.668 16.3335Z" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className='group-hover:stroke-black duration-500' />
                <path d="M37.3346 49V11.6667C37.3346 10.429 36.843 9.242 35.9678 8.36683C35.0926 7.49167 33.9056 7 32.668 7H23.3346C22.097 7 20.91 7.49167 20.0348 8.36683C19.1596 9.242 18.668 10.429 18.668 11.6667V49" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className='group-hover:stroke-black duration-500' />
            </svg>,
        },
        {
            id: 3,
    ...
    return (
        <div className='bg-[#0A0A0A]'>
            <div className="mx-auto px-3 max-w-[1140px]">
                <h2 className=' font-azo font-normal text-[35px] sm:text-[50px] md:text-[64px] text-white leading-[108%] text-center pt-[70px] sm:pt-4 pb-[54px]'>Utilities</h2>
                <div className="flex flex-wrap flex-row -mx-3 justify-center pb-[110px]">
                    {Doc.map((e) => <UtiliCards key={e.id} img={e.Image} heading={e.head} para={e.lines} />)}
                </div>
            </div>
        </div>
    )
